...
export type ExecCommandPart = (ExecCommandObject |
{ toString(): string; } |
  string) &
  Sluggable;
...
const isExecCommandObject = (maybe: unknown): maybe is ExecCommandObject => Boolean(maybe && (maybe as ExecCommandObject).getCommand);
